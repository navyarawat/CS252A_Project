...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.showVerses = function () {
        ...
        this.platform.ready().then(function () {
            ...
            // this.query = "";
            _this.bgService.load(_this.query, rflag).then(function (data) {
                console.log("LOG2 ");
                _this.verses = [];
                console.log(data);
...
var BgServiceProvider = /** @class */ (function () {
    ...
    BgServiceProvider.prototype.load = function (query, rflag) {
        var _this = this;
        console.log(query);
        if (this.data && !rflag) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_page1_page1__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_google_maps__ = __webpack_require__(281);
